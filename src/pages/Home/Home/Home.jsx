...
const Home = () => {
    ...
    return (
        <div className=' w-full'>
            ...
            <div className='h-[500px] w-full mb-5 relative'  data-aos="fade-up">
                <img src="/images/cars.png" className='w-full h-[500px]' alt="" />
                <div className='absolute top-0 h-[500px] w-full bg-[#ffdd009b]'>
                    <h2 className='lg:text-4xl text-2xl text-center font-bold pt-10'>20% Discount <br /> On All Kid's Education Toys</h2>
                    <p className='lg:text-3xl text-center py-5'>Offer Expires on</p>
                    <div className='bg-[#FE6B34] lg:p-14 p-5 w-fit rounded-xl lg:text-6xl text-3xl font-bold text-white lg:tracking-[10px] mx-auto'><Countdown date={Date.now() + 10000 * 100000} /></div>
