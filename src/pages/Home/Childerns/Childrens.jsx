...
const Children = () => {
    return (
        <div className='px-32 py-20'>
            <h3 className='text-4xl font-bold mt-10 pb-2 text-center'>About Kid's and Toys</h3>
            <p className='text-center mb-10'>It's not easy to make your child happy</p>
            
            <div className='grid lg:grid-cols-2' >
                <div className='lg:p-20'  data-aos="fade-down-right" data-aos-duration="2000" >
            ...
            <div className='grid lg:grid-cols-2'>
                ...
                <div className='lg:p-20'  data-aos="fade-down-left" data-aos-duration="2000">
