                    ...
                    <div className="flex flex-col items-center justify-center gap-10">
                        ...
                        <div>
                            ...
                            <div className={isAdd ? "block" : "hidden"}>
                                <input type="text"  {...register("photo2", { required: false })} placeholder="Product Photo2" className="pt-5 lg:w-[500px] ex:w-[500px] w-[300px] block py-2.5 px-0  text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
                                <input type="text"  {...register("photo3", { required: false })} placeholder="Product Photo3" className="pt-5 lg:w-[500px] ex:w-[500px] w-[300px] block py-2.5 px-0  text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
                                <input type="text"  {...register("photo4", { required: false })} placeholder="Product Photo4" className="pt-5 lg:w-[500px] ex:w-[500px] w-[300px] block py-2.5 px-0  text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
                                <input type="text"  {...register("photo5", { required: false })} placeholder="Product Photo5" className="pt-5 lg:w-[500px] ex:w-[500px] w-[300px] block py-2.5 px-0  text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
